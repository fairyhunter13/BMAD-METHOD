...
description: Sync local+origin default branch to upstream, rebase ALL feature branches onto default, and recursively sync submodule forks. Auto-detects default branch name. Use when syncing a fork with upstream, rebasing branches, or updating submodules.
---
...
# Then manually apply upstream's changes that don't conflict
# Read upstream's diff: git diff :1:<file> :2:<file>
```
