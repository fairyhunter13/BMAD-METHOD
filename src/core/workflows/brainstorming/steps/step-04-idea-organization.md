...
- **Append the final session content to `{scope_path}/brainstorming/brainstorming-session-{{date}}.md`**
...
When user selects 'C', append the content directly to `{scope_path}/brainstorming/brainstorming-session-{{date}}.md` using the structure from step 7.
