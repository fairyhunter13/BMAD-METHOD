...
- Look for file at `{scope_path}/brainstorming/brainstorming-session-{{date}}.md`
...
mkdir -p "$(dirname "{scope_path}/brainstorming/brainstorming-session-{{date}}.md")"

# Initialize from template
cp "{template_path}" "{scope_path}/brainstorming/brainstorming-session-{{date}}.md"
```
...
When user selects approach, append the session overview content directly to `{scope_path}/brainstorming/brainstorming-session-{{date}}.md` using the structure from above.
...
- **Append initial session overview to `{scope_path}/brainstorming/brainstorming-session-{{date}}.md`**
